...
const DoctorAppointment = () => {
  ...
  return (<>
    <div className='doctor-item'>
      ...
      <Link to={"/doctor/find/Cardiology"} style={{textDecoration:"none"}}  > 
      ...
      <hr  style={{width:"450px"}}/>
      <b className='last-para'>Treatment of side effect of cancer as pain,fatigue,hair loss</b>
    ...
    <div className='one-item'>
      <Link to={"/doctor/find/Hyper Tension"} style={{textDecoration:"none"}} > 
      <div className='doctor-detail'>
      ...
      <hr  style={{width:"450px"}}/>
      <b className='last-para'>consultancy for healthy diet and healthy body weight</b>
